...
import { pintarTarjeta, pintarCheckBox, applyFilters,mayores } from './module.js';
...
let searchBar = document.getElementById("searchbarpast");
...
async function obtenerEventos() {
    try {
        ...
        console.log(data);
        globalData.events = mayores(data) // Asigna los datos obtenidos a la variable global
